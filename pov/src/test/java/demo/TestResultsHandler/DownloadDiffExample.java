package demo.TestResultsHandler;

import demo.TestResultsHandler.ApplitoolsTestResultsHandler;
import demo.TestResultsHandler.ResultStatus;
...
//            System.getenv("APPLITOOLS_VIEW_KEY"),"ProxyServerURL","ProxyServerPort","ProxyServerUserName","ProxyServerPassword", System.getenv("APPLITOOLS_API_KEY"), System.getenv("APPLITOOLS_WRITE_KEY"));
            ...
            for (int i=0 ; i< results.length; i++){
                ...
                System.out.println("The result of step "+ names[i]+" is "+ results[i]);
            }
